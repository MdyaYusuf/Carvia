    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CuratorItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CuratorItems_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CuratorItems_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CuratorItems_CarId",
                table: "CuratorItems",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CuratorItems_UserId_CarId",
                table: "CuratorItems",
